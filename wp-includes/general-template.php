...
/* 		$html = sprintf( '<a href="%1$s" class="custom-logo-link" rel="home" itemprop="url">%2$s</a>',
		...
		$html = sprintf( '<a href="%1$s" class="custom-logo-link" rel="home" itemprop="url">%2$s</a>',
			esc_url( home_url( '/' ) ),
			'<img width="90" src="http://localhost/Myprojects/WordPress/PTN-News/wp-content/uploads/2018/06/cropped-152887561061036540-1-150x150.png" class="custom-logo" alt="" itemprop="logo">'
		);
	}
